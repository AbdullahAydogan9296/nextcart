    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <section className="mb-8">
                ...
                <p>
                    Welcome to NextCart eCommerce! We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy or our practices with regards to your personal information, please contact us at nextcart06@gmail.com
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p>
                    If you have questions or comments about this policy, you may email us at nextcart06@gmail.com or by post to: NextCart, 1234 Street Name, Gotham City, USA.
                </p>
            </section>
        </div>
    );
